...
def generar_articulos(cantidad, autores_disponibles, topico_a_id_map):
    ...
    for i in range(cantidad):
        ...
        envio_articulo_data.append({
            ...
            'usuario_autor': userid_cont, # Userid del contacto (asumiendo que 'usuario_autor' en la tabla es para esto)
            'contraseña_autor': password_cont # Password del contacto (hexadecimal) (asumiendo que 'contraseña_autor' es para esto)
        })
