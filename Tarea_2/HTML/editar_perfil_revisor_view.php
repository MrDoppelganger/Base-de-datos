...
<body>
    <div class="volver-container">
        <a href="../PHP/home_revisor.php" class="volver-link">🏠 Volver al Home</a>
    </div>
    ...
    <div class="editar-container">
        ...
        <form action="../PHP/editar_perfil_revisor.php" method="POST">
            <div>
                <label>RUT:</label>
        ...
        <div>
            ...
            <form action="../PHP/eliminar_cuenta_revisor.php" method="POST">
